/**
 * Twitch channel plugin for KolbBot.
 *
...
import { buildChannelConfigSchema } from "kolb-bot/plugin-sdk";
 ...
 * for KolbBot. Supports message sending, receiving, access control, and
 * status monitoring.
 */
