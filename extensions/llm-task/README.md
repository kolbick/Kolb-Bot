...
`kolb-bot.invoke --each`) without adding new KolbBot code per workflow.
...
This extension depends on KolbBot internal modules (the embedded agent runner).
It is intended to ship as a **bundled** KolbBot extension (like `lobster`) and
