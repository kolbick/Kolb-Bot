...
Nostr DM channel plugin for KolbBot using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to KolbBot. It enables your bot to:
