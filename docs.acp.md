...
This document describes how the KolbBot ACP (Agent Client Protocol) bridge works,
...
KolbBot Gateway over WebSocket. It keeps ACP session ids mapped to Gateway
...
drive a KolbBot Gateway session.
...
In Zed, open the Agent panel and select “KolbBot ACP” to start a thread.
