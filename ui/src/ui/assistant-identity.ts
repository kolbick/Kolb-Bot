...
declare global {
  interface Window {
    __KOLB_BOT_ASSISTANT_NAME__?: string;
    __KOLB_BOT_ASSISTANT_AVATAR__?: string;
  }
}
...
export function resolveInjectedAssistantIdentity(): AssistantIdentity {
  ...
  return normalizeAssistantIdentity({
    name: window.__KOLB_BOT_ASSISTANT_NAME__,
    avatar: window.__KOLB_BOT_ASSISTANT_AVATAR__,
  });
}
