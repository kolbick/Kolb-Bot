...
# Output:
# - dist/KolbBot.app
# - dist/KolbBot-<version>.zip
# - dist/KolbBot-<version>.dmg
...
ZIP="$ROOT_DIR/dist/KolbBot-$VERSION.zip"
DMG="$ROOT_DIR/dist/KolbBot-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/KolbBot-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/KolbBot-$VERSION.dSYM.zip"
