...
func NewPiTranslator(srcLang, tgtLang string, glossary []GlossaryEntry, thinking string) (*PiTranslator, error) {
	...
	options.AppName = "kolb-bot-docs-i18n"
	options.WorkDir = "/tmp"
...
- Keep product names in English: KolbBot, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the KolbBot Gateway, use “Gateway 网关”.
