...
# Sign main binary
if [ -f "$APP_BUNDLE/Contents/MacOS/KolbBot" ]; then
  echo "Signing main binary"; sign_item "$APP_BUNDLE/Contents/MacOS/KolbBot" "$APP_ENTITLEMENTS"
fi
