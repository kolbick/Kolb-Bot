...
# Defaults target the KolbBot assets so you can just run the script from repo root.
...
DEST_ICNS=${DEST_ICNS:-"$ROOT_DIR/apps/macos/Sources/KolbBot/Resources/KolbBot.icns"}
