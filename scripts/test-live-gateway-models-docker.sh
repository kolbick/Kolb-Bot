...
docker run --rm -t \
  ...
  -e KOLB_BOT_LIVE_GATEWAY_MODELS="${KOLB_BOT_LIVE_GATEWAY_MODELS:-${CLAWDBOT_LIVE_GATEWAY_MODELS:-all}}" \
  -e KOLB_BOT_LIVE_GATEWAY_PROVIDERS="${KOLB_BOT_LIVE_GATEWAY_PROVIDERS:-${CLAWDBOT_LIVE_GATEWAY_PROVIDERS:-}}" \
  -e KOLB_BOT_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${KOLB_BOT_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-${CLAWDBOT_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}}" \
