...
TRASH
  ...
  send_skills_flow() {
    ...
    workspace_dir="$HOME/.kolb-bot/workspace"
    config_path="$HOME/.kolb-bot/kolb-bot.json"
    sessions_dir="$HOME/.kolb-bot/agents/main/sessions"
...
NODE
  ...
  run_case_reset() {
    ...
    # Seed a remote config to exercise reset path.
	    cat > "$HOME/.kolb-bot/kolb-bot.json" <<'"'"'JSON'"'"'
{
