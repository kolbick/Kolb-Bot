...
if [[ -z "$version_content" ]]; then
  echo "<h2>KolbBot $VERSION</h2>"
  echo "<p>Latest KolbBot update.</p>"
  echo "<p><a href=\"https://github.com/kolb-bot/kolb-bot/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
