...
CDP_PORT="${KOLB_BOT_BROWSER_CDP_PORT:-9222}"
VNC_PORT="${KOLB_BOT_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${KOLB_BOT_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${KOLB_BOT_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${KOLB_BOT_BROWSER_HEADLESS:-0}"
