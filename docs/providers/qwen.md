---
summary: "Use Qwen OAuth (free tier) in KolbBot"
read_when:
  - You want to use Qwen with KolbBot
...
If you already logged in with the Qwen Code CLI, KolbBot will sync credentials
