---
summary: "Use Venice AI privacy-focused models in KolbBot"
read_when:
  - You want privacy-focused inference in KolbBot
...
```bash
kolb-bot chat --model venice/llama-3.3-70b "Hello, are you working?"
```

## Model Selection

After setup, KolbBot shows all available Venice models. Pick based on your needs:
...
```bash
kolb-bot models set venice/claude-opus-45
kolb-bot models set venice/llama-3.3-70b
```
...
KolbBot automatically discovers models from the Venice API when `VENICE_API_KEY` is set. If the API is unreachable, it falls back to a static catalog.
...
kolb-bot chat --model venice/llama-3.3-70b

# Use Claude via Venice (anonymized)
kolb-bot chat --model venice/claude-opus-45

# Use uncensored model
kolb-bot chat --model venice/venice-uncensored

# Use vision model with image
kolb-bot chat --model venice/qwen3-vl-235b-a22b

# Use coding model
kolb-bot chat --model venice/qwen3-coder-480b-a35b-instruct
```
