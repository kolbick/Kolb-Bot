---
summary: "Use Synthetic's Anthropic-compatible API in KolbBot"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. KolbBot registers it as the
...
Note: KolbBot's Anthropic client appends `/v1` to the base URL, so use
