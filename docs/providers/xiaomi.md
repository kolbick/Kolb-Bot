---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with KolbBot"
read_when:
  - You want Xiaomi MiMo models in KolbBot
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). KolbBot uses
