...
You can point KolbBot at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or KolbBot
...
- [Anthropic provider](/providers/anthropic) - Native KolbBot integration with Claude setup-token or API keys
