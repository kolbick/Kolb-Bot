---
summary: "Use Qianfan's unified API to access many models in KolbBot"
read_when:
...
3. KolbBot installed on your system
...
4. Copy the API key for use with KolbBot
...
- [KolbBot Configuration](/gateway/configuration)
