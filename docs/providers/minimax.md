---
summary: "Use MiniMax M2.1 in KolbBot"
read_when:
  - You want MiniMax models in KolbBot
...
See [MiniMax OAuth plugin README](https://github.com/kolb-bot/kolb-bot/tree/main/extensions/minimax-portal-auth) for details.
...
- Use `kolb-bot models list` and `kolb-bot models set minimax/MiniMax-M2.1` to switch.
...
- Running `kolb-bot configure` and selecting **MiniMax M2.1**, or
