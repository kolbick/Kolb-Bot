...
- During heartbeat runs, KolbBot treats `HEARTBEAT_OK` as an ack when it appears
...
If **all three** are false, KolbBot skips the heartbeat run entirely (no model call).
