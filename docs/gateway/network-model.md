...
- Canvas host is an HTTP file server on `canvasHost.port` (default `18793`) serving `/__kolb-bot__/canvas/` for node WebViews. See [Gateway configuration](/gateway/configuration) (`canvasHost`).
