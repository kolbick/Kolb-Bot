...
summary: Machine-checked security models for KolbBot’s highest-risk paths.
permalink: /security/formal-verification/
---

# Formal Verification (Security Models)

This page tracks KolbBot’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that KolbBot enforces its
...
**What this is not (yet):** a proof that “KolbBot is secure in all respects” or that the full TypeScript implementation is correct.
