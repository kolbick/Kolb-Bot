...
KolbBot has two separate “streaming” layers:
...
When block streaming is enabled, KolbBot can **merge consecutive block chunks**
...
When draft streaming is active, KolbBot disables block streaming for that reply to avoid double-streaming.
