...
Deploy KolbBot on Northflank with a one-click template and finish setup in your browser.
...
1. Click [Deploy KolbBot](https://northflank.com/stacks/deploy-kolb-bot) to open the template.
2. Create an [account on Northflank](https://app.northflank.com/signup) if you don’t already have one.
3. Click **Deploy KolbBot now**.
4. Set the required environment variable: `SETUP_PASSWORD`.
5. Click **Deploy stack** to build and run the KolbBot template.
6. Wait for the deployment to complete, then click **View resources**.
7. Open the KolbBot service.
8. Open the public KolbBot URL and complete setup at `/setup`.
9. Open the Control UI at `/kolb-bot`.
...
4. Click **Run setup**.
5. Open the Control UI at `https://<your-northflank-domain>/kolb-bot`
