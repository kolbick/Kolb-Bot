...
This guide summarizes a sane workflow for working on the pi integration in KolbBot.
...
State lives under the KolbBot state directory. Default is `~/.kolb-bot`. If `KOLB_BOT_STATE_DIR` is set, use that directory instead.
