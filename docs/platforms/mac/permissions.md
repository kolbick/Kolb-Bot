...
- Same path: run the app from a fixed location (for KolbBot, `dist/KolbBot.app`).
...
Workaround: move files into the KolbBot workspace (`~/.kolb-bot/workspace`) if you want to avoid per-folder grants.
