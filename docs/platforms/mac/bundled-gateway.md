...
KolbBot.app no longer bundles Node/Bun or the Gateway runtime. The macOS app
...
- `bot.molt.gateway` (or `bot.molt.<profile>`; legacy `com.kolb-bot.*` may remain)
...
- “KolbBot Active” enables/disables the LaunchAgent.
