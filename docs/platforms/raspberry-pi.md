---
summary: "KolbBot on Raspberry Pi (budget self-hosted setup)"
read_when:
  - Setting up KolbBot on a Raspberry Pi
  - Running KolbBot on ARM devices
  - Building a cheap always-on personal AI
title: "Raspberry Pi"
---

# KolbBot on Raspberry Pi

## Goal

Run a persistent, always-on KolbBot Gateway on a Raspberry Pi for **~$35-80** one-time cost (no monthly fees).
...
Most KolbBot features work on ARM64, but some external binaries may need ARM builds:
