...
- [Quick start and first-run setup]
  ...
  - [I can't access docs.kolb-bot.ai (SSL error). What now?](#i-cant-access-docskolb-botai-ssl-error-what-now)
...
### I cant access docs.kolb-bot.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.kolb-bot.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.kolb-bot.ai`, then retry. More
...
[https://kolb-bot.ai/install.ps1](https://kolb-bot.ai/install.ps1)
...
Showcase: [https://kolb-bot.ai/showcase](https://kolb-bot.ai/showcase)
