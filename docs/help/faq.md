---
summary: "Frequently asked questions about KolbBot setup, configuration, and usage"
title: "FAQ"
---
...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up KolbBot?](#whats-the-recommended-way-to-install-and-set-up-kolb-bot)
  ...
  - [I can't access github.com/kolbick/Kolb-Bot/blob/main/docs (SSL error). What now?](#i-cant-access-docskolb-botai-ssl-error-what-now)
  ...
  - [How do I install KolbBot on Linux?](#how-do-i-install-kolb-bot-on-linux)
  - [How do I install KolbBot on a VPS?](#how-do-i-install-kolb-bot-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask KolbBot to update itself?](#can-i-ask-kolb-bot-to-update-itself)
  ...
  - [If I buy a Mac mini to run KolbBot, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-kolb-bot-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different KolbBot instances?](#can-multiple-people-use-one-whatsapp-number-with-different-kolb-bot-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run KolbBot on a dedicated machine?](#how-important-is-it-to-run-kolb-bot-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run KolbBot in a VM and what are the requirements](#can-i-run-kolb-bot-in-a-vm-and-what-are-the-requirements)
- [What is KolbBot?](#what-is-kolb-bot)
  - [What is KolbBot, in one paragraph?](#what-is-kolb-bot-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for KolbBot](#what-are-the-top-five-everyday-use-cases-for-kolb-bot)
  - [Can KolbBot help with lead gen outreach ads and blogs for a SaaS](#can-kolb-bot-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can KolbBot run tasks on a schedule or continuously in the background?](#can-kolb-bot-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with KolbBot saved locally?](#is-all-data-used-with-kolb-bot-saved-locally)
  - [Where does KolbBot store its data?](#where-does-kolb-bot-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall KolbBot?](#how-do-i-completely-uninstall-kolb-bot)
...
- [Config basics](#config-basics)
  ...
  - [Can the KolbBot browser run headless?](#can-the-kolb-bot-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two KolbBot instances talk to each other (local + VPS)?](#can-two-kolb-bot-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does KolbBot load environment variables?](#how-does-kolb-bot-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of KolbBot instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-kolb-bot-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset KolbBot but keep it installed?](#how-do-i-completely-reset-kolb-bot-but-keep-it-installed)
  ...
  - [Why doesn't KolbBot reply in a group?](#why-doesnt-kolb-bot-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do KolbBot, Flawd, and Krill use for models?](#what-do-kolb-bot-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [How do I run KolbBot in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-kolb-bot-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart KolbBot?](#i-closed-my-terminal-on-windows-how-do-i-restart-kolb-bot)
...
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose KolbBot to inbound DMs?](#is-it-safe-to-expose-kolb-bot-to-inbound-dms)
...
This installs KolbBot **from a git checkout**, so the agent can read the code + docs and
...
[https://github.com/kolb-bot/kolb-bot/issues](https://github.com/kolb-bot/kolb-bot/issues)
[https://github.com/kolb-bot/kolb-bot/pulls](https://github.com/kolb-bot/kolb-bot/pulls)
...
### What's the recommended way to install and set up KolbBot
...
- **Tailscale Serve** (recommended): keep bind loopback, run `kolb-bot gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
...
1. Install KolbBot on the new machine.
...
[https://github.com/kolb-bot/kolb-bot/blob/main/CHANGELOG.md](https://github.com/kolb-bot/kolb-bot/blob/main/CHANGELOG.md)

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I cant access github.com/kolbick/Kolb-Bot/blob/main/docs SSL error What now

Some Comcast/Xfinity connections incorrectly block `github.com/kolbick/Kolb-Bot/blob/main/docs` via Xfinity
Advanced Security. Disable it or allowlist `github.com/kolbick/Kolb-Bot/blob/main/docs`, then retry. More
...
[https://github.com/kolb-bot/kolb-bot/tree/main/docs](https://github.com/kolb-bot/kolb-bot/tree/main/docs)
...
[https://github.com/kolbick/Kolb-Bot/install.ps1](https://github.com/kolbick/Kolb-Bot/install.ps1)
...
### How do I install KolbBot on Linux
...
### How do I install KolbBot on a VPS
...
### Can I ask KolbBot to update itself
...
No. You can run KolbBot with **API keys** (Anthropic/OpenAI/others) or with
...
Yes - via **setup-token**. KolbBot no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so KolbBot can keep replying while a provider is rate-limited.
...
KolbBot supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.3-codex` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. KolbBot fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Usually no. KolbBot needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. KolbBot runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run KolbBot can I connect it to my MacBook Pro
...
### Can multiple people use one WhatsApp number with different KolbBot instances
...
If you run KolbBot via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the KolbBot code install. Your state
...
**KolbBot-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run KolbBot on a dedicated machine
...
KolbBot is lightweight. For a basic Gateway + one chat channel:
...
### Can I run KolbBot in a VM and what are the requirements
...
### What is KolbBot in one paragraph

KolbBot is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

KolbBot is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for KolbBot
...
### Can KolbBot help with lead gen outreach ads and blogs for a SaaS
...
KolbBot draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

KolbBot is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use KolbBot when you
...
Showcase: [https://github.com/kolbick/Kolb-Bot/showcase](https://github.com/kolbick/Kolb-Bot/showcase)

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.kolb-bot/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.kolb-bot/kolb-bot.json`). Precedence is `<workspace>/skills` > `~/.kolb-bot/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.kolb-bot/kolb-bot.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.kolb-bot/skills` → bundled → `skills.load.extraDirs`. `kolbhub` installs into `./skills` by default, which KolbBot treats as `<workspace>/skills`.
...
Use **KolbHub** (CLI) or drop skills into your workspace. The macOS Skills UI isn't available on Linux.
Browse skills at [https://kolbhub.dev](https://kolbhub.dev).

Install the KolbHub CLI (pick one package manager):
...
### Can KolbBot run tasks on a schedule or continuously in the background
...
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. KolbBot can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
KolbHub installs into `./skills` under your current directory (or falls back to your configured KolbBot workspace); KolbBot treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.kolb-bot/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [KolbHub](/tools/kolbhub).
...
KolbBot memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

KolbBot also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, KolbBot auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, KolbBot
prefers `local`.
...
### Is all data used with KolbBot saved locally

No - **KolbBot's state is local**, but **external services still see what you send them**.
...
### Where does KolbBot store its data
...
| `$KOLB_BOT_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth + API keys)                             |
| `$KOLB_BOT_STATE_DIR/agents/<agentId>/agent/auth.json`          | Runtime auth cache (managed automatically)                   |
...
Do **not** commit anything under `~/.kolb-bot` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall KolbBot
...
`workspace` to the repo root. The KolbBot repo is just source code; keep the
...
KolbBot reads an optional **JSON5** config from `$KOLB_BOT_CONFIG_PATH` (default: `~/.kolb-bot/kolb-bot.json`):
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `kolb-bot doctor --generate-gateway-token`.
...
key. **Recommended:** run `kolb-bot configure --section web` to store it in
...
### Can the KolbBot browser run headless
...
### Can two KolbBot instances talk to each other local VPS
...
- Restore from backup (git or a copied `~/.kolb-bot/kolb-bot.json`).
...
### How does KolbBot load environment variables

KolbBot reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:
...
does **not** mean your env vars are missing - it just means KolbBot won't load
...
### Is there a way to make a team of KolbBot instances one CEO and many agents
...
### How do I completely reset KolbBot but keep it installed
...
headers like `# Heading`), KolbBot skips the heartbeat run to save API calls.
...
No. KolbBot runs on **your own account**, so if you're in the group, KolbBot can see it.
...
### Why doesnt KolbBot reply in a group
...
KolbBot's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, KolbBot currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- edit `agents.defaults.model` in `~/.kolb-bot/kolb-bot.json`
...
### What do KolbBot, Flawd, and Krill use for models

- **KolbBot + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-6`) - see [Anthropic](/providers/anthropic).
...
Yes. KolbBot ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
Cooldowns apply to failing profiles (exponential backoff), so KolbBot can keep responding even when a provider is rate-limited or temporarily failing.
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), KolbBot will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: KolbBot now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
KolbBot uses provider-prefixed IDs like:
...
KolbBot may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `kolb-bot models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.
...
KolbBot enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `kolb-bot gateway --port <port>`.

### How do I run KolbBot in remote mode client connects to a Gateway elsewhere
...
- The Control UI stores the token in browser localStorage key `kolb-bot.control.settings.v1`.
...
Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.kolb-bot.*`, `kolb-bot-gateway-<profile>.service`, `KolbBot Gateway (<profile>)`).
...
- Windows: `schtasks /Query /TN "KolbBot Gateway (<profile>)" /V /FO LIST`
...
### I closed my terminal on Windows how do I restart KolbBot
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [KolbBot assistant setup](/start/kolb-bot) and [Agent send](/tools/agent-send).
...
### Is it safe to expose KolbBot to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `kolb-bot pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `kolb-bot pairing list <channel>` if a code didn't arrive.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. KolbBot only replies to chats it receives or to explicit sends you trigger.
...
KolbBot blocks **cross-provider** messaging by default. If a tool call is bound
