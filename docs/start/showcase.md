...
summary: "Community-built projects and integrations powered by KolbBot"
---
...
OpenCode finishes the change → opens a PR → KolbBot reviews the diff and replies in Telegram with “minor suggestions” plus a clear merge verdict (including critical fixes to apply first).
...
Desktop app to manage skills/commands across Agents, Claude, Codex, and KolbBot.
...
CLI for Linear that integrates with agentic workflows (Claude Code, KolbBot). Manage issues, projects, and workflows from the terminal. First external PR merged!
</Card>
...
Claude Code discovered and confirmed the purifier controls, then KolbBot takes over to manage room air quality.
...
Triggered by a roof camera: ask KolbBot to snap a sky photo whenever it looks pretty — it designed a skill and took the shot.
...
A scheduled prompt generates a single "scene" image each morning (weather, tasks, date, favorite post/quote) via a KolbBot persona.
</Card>
...
Automated Todoist tasks and had KolbBot generate the skill directly in Telegram chat.
</Card>
...
<Card title="xuezh Chinese Learning" icon="language" href="https://github.com/joshp123/xuezh">
  **@joshp123** • `learning` `voice` `skill`
  ...
  Chinese learning engine with pronunciation feedback and study flows via KolbBot.
...
<Card title="GoHome Automation" icon="house-signal" href="https://github.com/joshp123/gohome">
  **@joshp123** • `home` `nix` `grafana`
  ...
  Nix-native home automation with KolbBot as the interface, plus beautiful Grafana dashboards.
...
<Card title="StarSwap Marketplace" icon="star" href="https://star-swap.com/">
  **Community** • `marketplace` `astronomy` `webapp`
  ...
  Full astronomy gear marketplace. Built with/around the KolbBot ecosystem.
</Card>
