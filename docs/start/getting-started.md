---
summary: "Get KolbBot installed and run your first chat in minutes."
read_when:
...
<Tooltip headline="Gateway host" tip="The machine running the KolbBot gateway service.">gateway host</Tooltip>.
...
<Steps>
  <Step title="Install KolbBot (recommended)">
    <Tabs>
