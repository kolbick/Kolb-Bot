---
summary: "Backstory and lore of KolbBot for context and tone"
read_when:
...
For a while, the lobster was called **Clawd**, living in a **Kolb-Bot**. But in January 2026, Anthropic sent a polite email asking for a name change (trademark stuff). And so the lobster did what lobsters do best:
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **KolbBot**.
...
In the end, **KolbBot** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
The **Moltiverse** is the community and ecosystem around KolbBot. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then KolbBot): _happily runs `find ~` and shares entire directory structure in group chat_
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at KolbBot" to promote pump-and-dump tokens.
...
**The Great KolbBot Migration** began.

In just 3 hours:

- GitHub renamed: `github.com/kolb-bot/kolb-bot` ✅
- X handle `@kolb-bot` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `github.com/kolbick/Kolb-Bot/blob/main/docs`
