...
Feishu (Lark) is a team chat platform used by companies for messaging and collaboration. This plugin connects KolbBot to a Feishu/Lark bot using the platform’s WebSocket event subscription so messages can be received without exposing a public webhook URL.
...
If you just installed KolbBot, run the wizard:
...
2. Configuring app credentials in KolbBot
