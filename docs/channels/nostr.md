...
read_when:
  - You want KolbBot to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables KolbBot to receive and respond to encrypted direct messages (DMs) via NIP-04.
