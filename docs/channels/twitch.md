...
read_when:
  - Setting up Twitch chat integration for KolbBot
title: "Twitch"
---

# Twitch (plugin)

Twitch chat support via IRC connection. KolbBot connects as a Twitch user (bot account) to receive and send messages in channels.
