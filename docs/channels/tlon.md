...
Tlon is a decentralized messenger built on Urbit. KolbBot connects to your Urbit ship and can
...
- Thread replies: if the inbound message is in a thread, KolbBot replies in-thread.
