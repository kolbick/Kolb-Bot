...
你可以将 KolbBot 指向该代理作为自定义 OpenAI 兼容端点：
...
- 这是一个**社区工具**，并非由 Anthropic 或 KolbBot 官方支持
...
- [Anthropic 提供商](/providers/anthropic) - KolbBot 与 Claude 的原生集成，使用 setup-token 或 API 密钥
