---
description: Real-world KolbBot projects from the community
summary: 社区构建的基于 KolbBot 的项目和集成
title: 案例展示
x-i18n:
...
来自社区的真实项目。看看大家正在用 KolbBot 构建什么。

<Info>
**想要展示你的项目？** 在 [Discord 的 #showcase 频道](https://discord.gg/kolb-bot) 分享或在 [X 上 @kolb-bot](https://x.com/kolb-bot)。
</Info>
...
>
  <iframe
    ...
    title="KolbBot: The self-hosted AI that Siri should have been (Full setup)"
...
>
  <iframe
    ...
    title="KolbBot community showcase"
    style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%" }}
    frameBorder="0"
    loading="lazy"
    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
...
OpenCode 完成更改 → 打开 PR → KolbBot 审查差异并在 Telegram 中回复"小建议"加上明确的合并决定（包括需要先应用的关键修复）。

  <img src="/assets/showcase/pr-review-telegram.jpg" alt="KolbBot PR review feedback delivered in Telegram" />
</Card>

<Card title="几分钟内创建酒窖 Skill" icon="wine-glass" href="https://x.com/i/status/2010916352454791216">
  **@prades_maxime** • `skills` `local` `csv`

向"Robby"（@kolb-bot）请求一个本地酒窖 skill。它请求一个示例 CSV 导出 + 存储位置，然后快速构建/测试该 skill（示例中有 962 瓶酒）。

  <img src="/assets/showcase/wine-cellar-skill.jpg" alt="KolbBot building a local wine cellar skill from CSV" />
</Card>
...
跨 Agents、Claude、Codex 和 KolbBot 管理 skills/命令的桌面应用。
...
<Card title="Bambu 3D 打印机控制" icon="print" href="https://kolbhub.dev/tobiasbischoff/bambu-cli">
...
<Card title="维也纳交通 (Wiener Linien)" icon="train" href="https://kolbhub.dev/hjanuschka/wienerlinien">
...
<Card title="R2 上传 (Send Me My Files)" icon="cloud-arrow-up" href="https://kolbhub.dev/skills/r2-upload">
  **@julianengel** • `files` `r2` `presigned-urls`

上传到 Cloudflare R2/S3 并生成安全的预签名下载链接。非常适合远程 KolbBot 实例。
</Card>
...
与智能体工作流（Claude Code、KolbBot）集成的 Linear CLI。从终端管理问题、项目和工作流。首个外部 PR 已合并！
</Card>
...
Claude Code 发现并确认了净化器控制，然后 KolbBot 接管来管理房间空气质量。

  <img src="/assets/showcase/winix-air-purifier.jpg" alt="Winix air purifier control via KolbBot" />
</Card>

<Card title="美丽天空相机拍摄" icon="camera" href="https://x.com/signalgaining/status/2010523120604746151">
  **@signalgaining** • `automation` `camera` `skill` `images`

由屋顶摄像头触发：让 KolbBot 在天空看起来很美的时候拍一张照片——它设计了一个 skill 并拍摄了照片。

  <img src="/assets/showcase/roof-camera-sky.jpg" alt="Roof camera sky snapshot captured by KolbBot" />
</Card>

<Card title="可视化晨间简报场景" icon="robot" href="https://x.com/buddyhadry/status/2010005331925954739">
  **@buddyhadry** • `automation` `briefing` `images` `telegram`

定时提示每天早上通过 KolbBot 角色生成一张"场景"图片（天气、任务、日期、喜欢的帖子/引言）。
</Card>
...
KolbBot 连接到 Jira，然后即时生成一个新的 skill（在它出现在 KolbHub 之前）。
</Card>
...
自动化 Todoist 任务，并让 KolbBot 直接在 Telegram 聊天中生成 skill。
</Card>
...
<Card title="xuezh 中文学习" icon="language" href="https://github.com/joshp123/xuezh">
  **@joshp123** • `learning` `voice` `skill`
  ...
  通过 KolbBot 实现带有发音反馈和学习流程的中文学习引擎。
...
<Card title="Clawdia 电话桥接" icon="phone" href="https://github.com/alejandroOPI/clawdia-bridge">
  **@alejandroOPI** • `voice` `vapi` `bridge`
  ...
  Vapi 语音助手 ↔ KolbBot HTTP 桥接。与你的智能体进行近实时电话通话。
</Card>

<Card title="OpenRouter 转录" icon="microphone" href="https://kolbhub.dev/obviyus/openrouter-transcribe">
  **@obviyus** • `transcription` `multilingual` `skill`

通过 OpenRouter（Gemini 等）进行多语言音频转录。可在 KolbHub 获取。
</Card>
...
<Card title="Home Assistant 插件" icon="home" href="https://github.com/ngutman/kolb-bot-ha-addon">
  **@ngutman** • `homeassistant` `docker` `raspberry-pi`
  
  在 Home Assistant OS 上运行的 KolbBot Gateway 网关，支持 SSH 隧道和持久状态。
</Card>
...
<Card title="Nix 打包" icon="snowflake" href="https://github.com/kolb-bot/nix-kolb-bot">
  **@kolb-bot** • `nix` `packaging` `deployment`
  
  开箱即用的 nixified KolbBot 配置，用于可复现的部署。
</Card>

<Card title="CalDAV 日历" icon="calendar" href="https://kolbhub.dev/skills/caldav-calendar">
...
<Card title="GoHome 自动化" icon="house-signal" href="https://github.com/joshp123/gohome">
  **@joshp123** • `home` `nix` `grafana`
  ...
  Nix 原生家庭自动化，以 KolbBot 作为界面，加上漂亮的 Grafana 仪表板。
...
<Steps>
  <Step title="分享它">
    在 [Discord 的 #showcase 频道](https://discord.gg/kolb-bot) 发布或在 [Twitter 上 @kolb-bot](https://x.com/kolb-bot)
  </Step>
  <Step title="包含详细信息">
