...
export function listSlackAccountIds(cfg: KolbBotConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: KolbBotConfig): string {
...
function mergeSlackAccountConfig(cfg: KolbBotConfig, accountId: string): SlackAccountConfig {
