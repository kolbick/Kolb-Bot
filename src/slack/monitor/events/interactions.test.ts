            ...
            values: {
              ...
              email_block: {
                email_input: {
                  ...
                  value: "team@kolb-bot.ai",
                },
              },
              url_block: {
                url_input: {
                  type: "url_text_input",
                  value: "https://github.com/kolbick/Kolb-Bot/blob/main/docs",
                },
              },
              richtext_block: {
                richtext_input: {
    ...
    expect(payload.inputs).toEqual(
      expect.arrayContaining([
        ...
        expect.objectContaining({
          ...
          inputKind: "email",
          inputEmail: "team@kolb-bot.ai",
        }),
        expect.objectContaining({
          actionId: "url_input",
          inputKind: "url",
          inputUrl: "https://github.com/kolbick/Kolb-Bot/blob/main/docs/",
        }),
        expect.objectContaining({
