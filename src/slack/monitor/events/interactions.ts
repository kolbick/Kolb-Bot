...
// Prefix for KolbBot-generated action IDs to scope our handler
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  // Handle Block Kit button clicks from KolbBot-generated messages
  ...
  // Handle KolbBot modal submissions with callback_ids scoped by our prefix.
  ctx.app.view(
    new RegExp(`^${KOLB_BOT_ACTION_PREFIX}`),
