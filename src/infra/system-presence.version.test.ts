...
describe("system-presence version fallback", () => {
  it("uses KOLB_BOT_SERVICE_VERSION when KOLB_BOT_VERSION is not set", async () => {
  ...
  it("prefers KOLB_BOT_VERSION over KOLB_BOT_SERVICE_VERSION", async () => {
    await withPresenceModule(
      {
  ...
  it("uses npm_package_version when KOLB_BOT_VERSION and KOLB_BOT_SERVICE_VERSION are blank", async () => {
    await withPresenceModule(
      {
        KOLB_BOT_VERSION: " ",
