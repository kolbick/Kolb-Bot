    ...
    if (isUnsupportedGuiDomain(detail)) {
      throw new Error(
        [
          ...
          "Headless deployments should use a dedicated logged-in user session or a custom LaunchDaemon (not shipped): https://github.com/kolbick/Kolb-Bot/blob/main/docs/gateway",
        ].join("\n"),
      );
    }
