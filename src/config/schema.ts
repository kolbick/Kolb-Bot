...
const FIELD_HELP: Record<string, string> = {
  "meta.lastTouchedVersion": "Auto-set when KolbBot writes the config.",
  ...
  "agents.defaults.memorySearch.store.path":
    "SQLite index path (default: ~/.kolb-bot/memory/{agentId}.sqlite).",
  ...
  "memory.backend": 'Memory backend ("builtin" for KolbBot embeddings, "qmd" for QMD sidecar).',
