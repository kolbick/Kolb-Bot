...
function isTelegramConfigured(cfg: KolbBotConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: KolbBotConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: KolbBotConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: KolbBotConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: KolbBotConfig): boolean {
...
function isIMessageConfigured(cfg: KolbBotConfig): boolean {
