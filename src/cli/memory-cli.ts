...
import { getMemorySearchManager, type MemorySearchManagerResult } from "../memory-core/index.js";
import { listMemoryFiles, normalizeExtraMemoryPaths } from "../memory-core/internal.js";
...
export function registerMemoryCli(program: Command) {
  const memory = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/memory", "docs.kolb-bot.ai/cli/memory")}\n`,
    );
