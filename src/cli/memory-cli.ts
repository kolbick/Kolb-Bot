    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ...
          ['kolb-bot memory search --query "deployment notes"', "Search indexed memory entries."],
          ["kolb-bot memory status --json", "Output machine-readable JSON."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/memory", "github.com/kolbick/Kolb-Bot/blob/main/docs/cli/memory")}\n`,
    );
