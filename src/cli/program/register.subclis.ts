...
const loadConfig = async (): Promise<KolbBotConfig> => {
...
const entries: SubCliEntry[] = [
  ...
  {
    name: "docs",
    description: "Search the live KolbBot docs",
    hasSubcommands: false,
    register: async (program) => {
  ...
  {
    name: "plugins",
    description: "Manage KolbBot plugins and extensions",
    hasSubcommands: true,
    register: async (program) => {
  ...
  {
    name: "update",
    description: "Update KolbBot and inspect update channel status",
    hasSubcommands: true,
    register: async (program) => {
