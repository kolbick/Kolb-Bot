...
const UPDATE_QUIPS = [
  ...
  "Fresh code, same pirate. Miss me?",
  "Back and better. Did you even notice I was gone?",
  "Update complete. I learned some new tricks while I was out.",
  "Upgraded! Now with 23% more sass.",
  "I've evolved. Try to keep up.",
  "New version, who dis? Oh right, still me but shinier.",
  "Patched, polished, and ready to plunder. Let's go.",
  "The pirate has returned. Sharper cutlass, darker flag.",
  ...
  "Upgraded! Kolby fixed stuff. Blame him if it breaks.",
  "Upgrade complete. The crew salutes the new captain.",
...
const KOLB_BOT_REPO_URL = "https://github.com/kolbick/Kolb-Bot.git";
...
function normalizeTag(value?: string | null): string | null {
  ...
  if (trimmed.startsWith("kolb-bot@")) {
    return trimmed.slice("kolb-bot@".length);
  }
...
export async function updateStatusCommand(opts: UpdateStatusOptions): Promise<void> {
  ...
  defaultRuntime.log(theme.heading("KolbBot update status"));
  defaultRuntime.log("");
  defaultRuntime.log(
    renderTable({
      width: tableWidth,
...
export async function updateCommand(opts: UpdateCommandOptions): Promise<void> {
  ...
  if (!opts.json) {
    defaultRuntime.log(theme.heading("Updating KolbBot..."));
    defaultRuntime.log("");
  }
  ...
  if (result.status === "skipped") {
    ...
    if (result.reason === "not-git-install") {
      defaultRuntime.log(
        theme.warn(
          `Skipped: this KolbBot install isn't a git checkout, and the package manager couldn't be detected. Update via your package manager, then run \`${replaceCliName(formatCliCommand("kolb-bot doctor"), CLI_NAME)}\` and \`${replaceCliName(formatCliCommand("kolb-bot gateway restart"), CLI_NAME)}\`.`,
        ),
      );
      defaultRuntime.log(
        theme.muted(
...
export function registerUpdateCli(program: Command) {
  const update = program
    .command("update")
    .description("Update KolbBot to the latest version")
