const DEFAULT_TAGLINE = "All your chats, one Kolb-Bot. Arrr.";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—Santa's little pirate assistant is here to ship joy, roll back chaos, and stash the treasure safely.",
...
const TAGLINES: string[] = [
  "Ahoy! Your terminal just got boarded—let the bot plunder the busywork.",
  "Welcome to the command line: where dreams compile and confidence walks the plank.",
  'I run on caffeine, JSON5, and the audacity of "it worked on my machine."',
  "Gateway online—all hands on deck, captain.",
  ...
  "Pairing codes exist because even pirate bots believe in consent—and good security hygiene.",
  "Your .env is showing; don't worry, I'll pretend I didn't see the treasure map.",
  "I'll do the boring stuff while you dramatically stare at the logs like it's the horizon.",
  "I'm not saying your workflow is chaotic... I'm just bringing a cutlass and a linter.",
  ...
  "I'm the first mate your terminal demanded, not the one your sleep schedule requested.",
  "I keep secrets like buried treasure... unless you print them in debug logs again.",
  "Automation with a skull and crossbones: minimal fuss, maximal plunder.",
  "I'm basically a Swiss Army cutlass, but with more opinions and fewer sharp edges.",
  "If you're lost, run doctor; if you're brave, run prod; if you're wise, run tests.",
  "Your task has been queued; your dignity has been sent to Davy Jones.",
  "I can't fix your code taste, but I can fix your build and your backlog.",
  "I'm not magic—I'm just extremely persistent with retries and pirate stubbornness.",
  ...
  "If something's on fire, I can't extinguish it—but I can write a beautiful captain's log.",
  "I'll plunder your busywork like it owes me doubloons.",
  ...
  "I'm like tmux: confusing at first, then suddenly you can't sail without me.",
  ...
  "Your config is valid, your assumptions are walking the plank.",
  ...
  "Skull up, commit in—let's ship something mildly responsible.",
  "Months of Kolby's hacking, distilled into one pirate bot.",
  "Shell yeah—I'm here to plunder the toil and leave you the glory.",
  "If it's repetitive, I'll automate it; if it's hard, I'll bring jokes and a rollback plan.",
  "Because texting yourself reminders is so 2024.",
  "Your inbox, your infra, your ship.",
  'Turning "I\'ll reply later" into "my bot replied instantly".',
  "The only pirate in your contacts you actually want to hear from. ☠️",
  ...
  "Ship fast, log faster. That's the pirate way.",
  ...
  "Built from months of open-source AI tinkering. Worth every commit.",
  ...
  "Local AI, pirate vibes, zero vendor lock-in.",
  "Kolby's revenge on corporate AI assistants.",
  "Works on Android. Crazy concept, we know.",
  "No subscription required. Your hardware, your rules.",
  "Self-hosted AI that doesn't phone home.",
  "Your AI assistant, running on your own deck.",
  "Think different. Actually think.",
  "Born from late nights and local LLMs. ☠️",
