 ...
 * a hint.
 *
 * See: https://github.com/kolbick/Kolb-Bot/issues/17328
 */
const LOCAL_PROVIDER_HINTS: Record<string, string> = {
  ollama:
    ...
    "See: https://github.com/kolbick/Kolb-Bot/blob/main/docs/providers/ollama",
  vllm:
    "vLLM requires authentication to be registered as a provider. " +
    'Set VLLM_API_KEY (any value works) or run "kolb-bot configure". ' +
    "See: https://github.com/kolbick/Kolb-Bot/blob/main/docs/providers/vllm",
};
