...
describe("buildAgentSystemPrompt", () => {
  ...
  it("includes a CLI quick reference section", () => {
    ...
    expect(prompt).toContain("## KolbBot CLI Quick Reference");
  ...
  it("preserves tool casing in the prompt", () => {
    ...
    expect(prompt).toContain("KolbBot docs: /tmp/kolb-bot/docs");
    expect(prompt).toContain(
  ...
  // See: https://github.com/kolby/kolb-bot/commit/66eec295b894bce8333886cfbca3b960c57c4946
  // Agents should use session_status or message timestamps to determine the date/time.
  // Related: https://github.com/kolby/kolb-bot/issues/1897
  //          https://github.com/kolby/kolb-bot/issues/3658
  it("does NOT include a date or time in the system prompt (cache stability)", () => {
    ...
    // https://github.com/kolby/kolb-bot/issues/3658 for the preferred approach:
  ...
  it("adds ClaudeBot self-update guidance when gateway tool is available", () => {
    ...
    expect(prompt).toContain("## KolbBot Self-Update");
