...
export const handleRestartCommand: CommandHandler = async (params, allowTextCommands) => {
  ...
  if (hasSigusr1Listener) {
    ...
    return {
      shouldContinue: false,
      reply: {
        text: "⚙️ Restarting KolbBot in-process (SIGUSR1); back in a few seconds.",
      },
    };
  }
  ...
  return {
    shouldContinue: false,
    reply: {
      text: `⚙️ Restarting KolbBot via ${restartMethod.method}; give me a few seconds to come back online.`,
    },
  };
};
