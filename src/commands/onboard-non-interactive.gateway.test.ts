...
describe("onboard (non-interactive): gateway and remote auth", () => {
  const prev = {
    ...
    skipBrowser: process.env.KOLB_BOT_SKIP_BROWSER_CONTROL_SERVER,
  ...
  beforeAll(async () => {
    ...
    tempHome = await fs.mkdtemp(path.join(os.tmpdir(), "kolb-bot-onboard-"));
  ...
  afterAll(async () => {
    ...
    process.env.KOLB_BOT_STATE_DIR = prev.stateDir;
    process.env.KOLB_BOT_CONFIG_PATH = prev.configPath;
    process.env.KOLB_BOT_SKIP_CHANNELS = prev.skipChannels;
    process.env.KOLB_BOT_SKIP_GMAIL_WATCHER = prev.skipGmail;
    process.env.KOLB_BOT_SKIP_CRON = prev.skipCron;
    process.env.KOLB_BOT_SKIP_CANVAS_HOST = prev.skipCanvas;
    process.env.KOLB_BOT_SKIP_BROWSER_CONTROL_SERVER = prev.skipBrowser;
    process.env.KOLB_BOT_GATEWAY_TOKEN = prev.token;
    process.env.KOLB_BOT_GATEWAY_PASSWORD = prev.password;
  });
