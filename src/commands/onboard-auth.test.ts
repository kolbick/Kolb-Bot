...
describe("writeOAuthCredentials", () => {
  ...
  it("writes auth-profiles.json under KOLB_BOT_AGENT_DIR when set", async () => {
    tempStateDir = await fs.mkdtemp(path.join(os.tmpdir(), "kolb-bot-oauth-"));
    process.env.KOLB_BOT_STATE_DIR = tempStateDir;
    process.env.KOLB_BOT_AGENT_DIR = path.join(tempStateDir, "agent");
    process.env.PI_CODING_AGENT_DIR = process.env.KOLB_BOT_AGENT_DIR;
...
describe("setMinimaxApiKey", () => {
  ...
  it("writes to KOLB_BOT_AGENT_DIR when set", async () => {
    tempStateDir = await fs.mkdtemp(path.join(os.tmpdir(), "kolb-bot-minimax-"));
    process.env.KOLB_BOT_STATE_DIR = tempStateDir;
    process.env.KOLB_BOT_AGENT_DIR = path.join(tempStateDir, "custom-agent");
    process.env.PI_CODING_AGENT_DIR = process.env.KOLB_BOT_AGENT_DIR;
