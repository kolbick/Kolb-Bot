 ...
 */
export async function noteMemorySearchHealth(cfg: KolbBotConfig): Promise<void> {
  ...
  if (resolved.provider !== "auto") {
    ...
    note(
      [
        ...
        `- Add credentials: ${formatCliCommand(`kolb-bot auth add --provider ${resolved.provider}`)}`,
  ...
  note(
    [
      ...
      `- Add credentials: ${formatCliCommand("kolb-bot auth add --provider openai")}`,
