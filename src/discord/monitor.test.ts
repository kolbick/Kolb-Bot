...
describe("discord allowlist helpers", () => {
  it("normalizes slugs", () => {
    expect(normalizeDiscordSlug("Friends of KolbBot")).toBe("friends-of-kolb-bot");
  ...
  it("matches ids or names", () => {
    const allow = normalizeDiscordAllowList(
      ["123", "steipete", "Friends of KolbBot"],
    ...
    expect(allowListMatches(allow, { name: "friends-of-kolb-bot" })).toBe(true);
...
describe("discord guild/channel resolution", () => {
  it("resolves guild entry by id", () => {
    ...
    const resolved = resolveDiscordGuildEntry({
      guild: fakeGuild("123", "Friends of KolbBot"),
      guildEntries,
    });
