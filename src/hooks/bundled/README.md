...
This directory contains hooks that ship with KolbBot. These hooks are automatically discovered and can be enabled/disabled via CLI or configuration.
...
homepage: https://github.com/kolbick/Kolb-Bot/blob/main/docs/automation/hooks#my-hook
metadata:
...
Hooks can be configured in `~/.kolb-bot/kolb-bot.json`:
...
Full documentation: https://github.com/kolbick/Kolb-Bot/blob/main/docs/automation/hooks
