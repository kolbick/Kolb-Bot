...
import type { KolbBotPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: KolbBotPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: KolbBotPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
