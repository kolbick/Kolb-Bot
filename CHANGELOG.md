...
Kolb-Bot release history. Upstream Open WebUI history is preserved in
`docs/UPSTREAM_CHANGELOG.md`.

## [0.9.6] - 2026-07-17

### Added

- **Kolb-Bot brand**: complete rebrand of the application derived from Open WebUI v0.9.6 — name, logos, favicons, PWA identity, splash screens, locale strings in every bundled language, manifests, metadata, and Docker labels.
...
- **Kolb Terminal**: opt-in terminal service scaffold built from Open Terminal source with strict isolation defaults.
