...
- **Kolb-Bot brand**: complete rebrand of the application derived from the upstream dev branch at version 0.10.2-dev (see docs/UPSTREAM.md) — name, logos, favicons, PWA identity, splash screens, locale strings in every bundled language, manifests, metadata, and Docker labels.
