...
GH_TOKEN=$(cat ~/.kolb-bot/kolb-bot.json 2>/dev/null | jq -r '.skills.entries["gh-issues"].apiKey // empty') || GH_TOKEN=$(cat /data/.kolb-bot/kolb-bot.json 2>/dev/null | jq -r '.skills.entries["gh-issues"].apiKey // empty')
