...
```
http://<host>:18793/__kolb-bot__/canvas/index.html  → ~/clawd/canvas/index.html
http://<host>:18793/__kolb-bot__/canvas/games/snake.html → ~/clawd/canvas/games/snake.html
```
