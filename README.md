...
<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/kolbick/Kolb-Bot/main/docs/assets/kolb-bot-logo-text-dark.png">
        <img src="https://raw.githubusercontent.com/kolbick/Kolb-Bot/main/docs/assets/kolb-bot-logo-text.png" alt="KolbBot" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/kolbick/Kolb-Bot/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/kolbick/Kolb-Bot/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/kolbick/Kolb-Bot/releases"><img src="https://img.shields.io/github/v/release/kolbick/Kolb-Bot?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/clawd"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**KolbBot** is a _personal AI assistant_ you run on your own devices.
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, Microsoft Teams, WebChat), plus extension channels like BlueBubbles, Matrix, Zalo, and Zalo Personal. It can speak and listen on macOS/iOS/Android, and can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that feels local, fast, and always-on, this is it.

[Website](https://kolb-bot.ai) · [Docs](https://docs.kolb-bot.ai) · [DeepWiki](https://deepwiki.com/kolbick/Kolb-Bot) · [Getting Started](https://docs.kolb-bot.ai/start/getting-started) · [Updating](https://docs.kolb-bot.ai/install/updating) · [Showcase](https://docs.kolb-bot.ai/start/showcase) · [FAQ](https://docs.kolb-bot.ai/start/faq) · [Wizard](https://docs.kolb-bot.ai/start/wizard) · [Nix](https://github.com/kolb-bot/nix-kolb-bot) · [Docker](https://docs.kolb-bot.ai/install/docker) · [Discord](https://discord.gg/clawd)

Preferred setup: run the onboarding wizard (`kolb-bot onboard`) in your terminal.
The wizard guides you step by step through setting up the gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: [Getting started](https://docs.kolb-bot.ai/start/getting-started)
...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.6** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.kolb-bot.ai/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.kolb-bot.ai/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.kolb-bot.ai/concepts/model-failover)
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs.kolb-bot.ai/start/getting-started)
...
# Send a message
kolb-bot message send --to +1234567890 --message "Hello from KolbBot"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
kolb-bot agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.kolb-bot.ai/install/updating) (and run `kolb-bot doctor`).
...
Details: [Development channels](https://docs.kolb-bot.ai/install/development-channels).
...
KolbBot connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.kolb-bot.ai/gateway/security)
...
- **[Local-first Gateway](https://docs.kolb-bot.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.kolb-bot.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, BlueBubbles (iMessage), iMessage (legacy), Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.kolb-bot.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.kolb-bot.ai/nodes/voicewake) + [Talk Mode](https://docs.kolb-bot.ai/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.kolb-bot.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.kolb-bot.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.kolb-bot.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.kolb-bot.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.kolb-bot.ai/nodes).
- **[Onboarding](https://docs.kolb-bot.ai/start/wizard) + [skills](https://docs.kolb-bot.ai/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=kolbick/Kolb-Bot&type=date&legend=top-left)](https://www.star-history.com/#kolbick/Kolb-Bot&type=date&legend=top-left)

## Everything we built so far

### Core platform

- [Gateway WS control plane](https://docs.kolb-bot.ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.kolb-bot.ai/web), and [Canvas host](https://docs.kolb-bot.ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.kolb-bot.ai/tools/agent-send): gateway, agent, send, [wizard](https://docs.kolb-bot.ai/start/wizard), and [doctor](https://docs.kolb-bot.ai/gateway/doctor).
- [Pi agent runtime](https://docs.kolb-bot.ai/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.kolb-bot.ai/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.kolb-bot.ai/concepts/groups).
- [Media pipeline](https://docs.kolb-bot.ai/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.kolb-bot.ai/nodes/audio).

### Channels

- [Channels](https://docs.kolb-bot.ai/channels): [WhatsApp](https://docs.kolb-bot.ai/channels/whatsapp) (Baileys), [Telegram](https://docs.kolb-bot.ai/channels/telegram) (grammY), [Slack](https://docs.kolb-bot.ai/channels/slack) (Bolt), [Discord](https://docs.kolb-bot.ai/channels/discord) (discord.js), [Google Chat](https://docs.kolb-bot.ai/channels/googlechat) (Chat API), [Signal](https://docs.kolb-bot.ai/channels/signal) (signal-cli), [BlueBubbles](https://docs.kolb-bot.ai/channels/bluebubbles) (iMessage, recommended), [iMessage](https://docs.kolb-bot.ai/channels/imessage) (legacy imsg), [Microsoft Teams](https://docs.kolb-bot.ai/channels/msteams) (extension), [Matrix](https://docs.kolb-bot.ai/channels/matrix) (extension), [Zalo](https://docs.kolb-bot.ai/channels/zalo) (extension), [Zalo Personal](https://docs.kolb-bot.ai/channels/zalouser) (extension), [WebChat](https://docs.kolb-bot.ai/web/webchat).
- [Group routing](https://docs.kolb-bot.ai/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.kolb-bot.ai/channels).

### Apps + nodes

- [macOS app](https://docs.kolb-bot.ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs.kolb-bot.ai/nodes/voicewake)/PTT, [Talk Mode](https://docs.kolb-bot.ai/nodes/talk) overlay, [WebChat](https://docs.kolb-bot.ai/web/webchat), debug tools, [remote gateway](https://docs.kolb-bot.ai/gateway/remote) control.
- [iOS node](https://docs.kolb-bot.ai/platforms/ios): [Canvas](https://docs.kolb-bot.ai/platforms/mac/canvas), [Voice Wake](https://docs.kolb-bot.ai/nodes/voicewake), [Talk Mode](https://docs.kolb-bot.ai/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.kolb-bot.ai/platforms/android): [Canvas](https://docs.kolb-bot.ai/platforms/mac/canvas), [Talk Mode](https://docs.kolb-bot.ai/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.kolb-bot.ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.kolb-bot.ai/tools/browser): dedicated kolb-bot Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.kolb-bot.ai/platforms/mac/canvas): [A2UI](https://docs.kolb-bot.ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.kolb-bot.ai/nodes): camera snap/clip, screen record, [location.get](https://docs.kolb-bot.ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.kolb-bot.ai/automation/cron-jobs); [webhooks](https://docs.kolb-bot.ai/automation/webhook); [Gmail Pub/Sub](https://docs.kolb-bot.ai/automation/gmail-pubsub).
- [Skills platform](https://docs.kolb-bot.ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.kolb-bot.ai/concepts/channel-routing), [retry policy](https://docs.kolb-bot.ai/concepts/retry), and [streaming/chunking](https://docs.kolb-bot.ai/concepts/streaming).
- [Presence](https://docs.kolb-bot.ai/concepts/presence), [typing indicators](https://docs.kolb-bot.ai/concepts/typing-indicators), and [usage tracking](https://docs.kolb-bot.ai/concepts/usage-tracking).
- [Models](https://docs.kolb-bot.ai/concepts/models), [model failover](https://docs.kolb-bot.ai/concepts/model-failover), and [session pruning](https://docs.kolb-bot.ai/concepts/session-pruning).
- [Security](https://docs.kolb-bot.ai/gateway/security) and [troubleshooting](https://docs.kolb-bot.ai/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.kolb-bot.ai/web) + [WebChat](https://docs.kolb-bot.ai/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.kolb-bot.ai/gateway/tailscale) or [SSH tunnels](https://docs.kolb-bot.ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs.kolb-bot.ai/install/nix) for declarative config; [Docker](https://docs.kolb-bot.ai/install/docker)-based installs.
- [Doctor](https://docs.kolb-bot.ai/gateway/doctor) migrations, [logging](https://docs.kolb-bot.ai/logging).
...
- **[Gateway WebSocket network](https://docs.kolb-bot.ai/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.kolb-bot.ai/gateway)).
- **[Tailscale exposure](https://docs.kolb-bot.ai/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.kolb-bot.ai/gateway/remote)).
- **[Browser control](https://docs.kolb-bot.ai/tools/browser)** — kolb-bot‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.kolb-bot.ai/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.kolb-bot.ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.kolb-bot.ai/nodes/voicewake) + [Talk Mode](https://docs.kolb-bot.ai/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.kolb-bot.ai/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

KolbBot can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (KolbBot enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.kolb-bot.ai/gateway/tailscale) · [Web surfaces](https://docs.kolb-bot.ai/web)
...
Details: [Remote access](https://docs.kolb-bot.ai/gateway/remote) · [Nodes](https://docs.kolb-bot.ai/nodes) · [Security](https://docs.kolb-bot.ai/gateway/security)
...
Details: [Nodes](https://docs.kolb-bot.ai/nodes) · [macOS app](https://docs.kolb-bot.ai/platforms/macos) · [Gateway protocol](https://docs.kolb-bot.ai/concepts/architecture)
...
Details: [Session tools](https://docs.kolb-bot.ai/concepts/session-tool)
...
Runbook: [iOS connect](https://docs.kolb-bot.ai/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.kolb-bot.ai/platforms/android).
...
Minimal `~/.kolbick/Kolb-Bot.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.kolb-bot.ai/gateway/configuration)
...
Details: [Security guide](https://docs.kolb-bot.ai/gateway/security) · [Docker + sandboxing](https://docs.kolb-bot.ai/install/docker) · [Sandbox config](https://docs.kolb-bot.ai/gateway/configuration)

### [WhatsApp](https://docs.kolb-bot.ai/channels/whatsapp)

- Link the device: `pnpm kolb-bot channels login` (stores creds in `~/.kolb-bot/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.kolb-bot.ai/channels/telegram)
...
### [Slack](https://docs.kolb-bot.ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.kolb-bot.ai/channels/discord)
...
### [Signal](https://docs.kolb-bot.ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [BlueBubbles (iMessage)](https://docs.kolb-bot.ai/channels/bluebubbles)

- **Recommended** iMessage integration.
- Configure `channels.bluebubbles.serverUrl` + `channels.bluebubbles.password` and a webhook (`channels.bluebubbles.webhookPath`).
- The BlueBubbles server runs on macOS; the Gateway can run on macOS or elsewhere.

### [iMessage (legacy)](https://docs.kolb-bot.ai/channels/imessage)

- Legacy macOS-only integration via `imsg` (Messages must be signed in).
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.kolb-bot.ai/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.kolb-bot.ai/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.kolb-bot.ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs.kolb-bot.ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.kolb-bot.ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.kolb-bot.ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.kolb-bot.ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.kolb-bot.ai/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.kolb-bot.ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.kolb-bot.ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.kolb-bot.ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.kolb-bot.ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.kolb-bot.ai/platforms/windows), [Linux](https://docs.kolb-bot.ai/platforms/linux), [macOS](https://docs.kolb-bot.ai/platforms/macos), [iOS](https://docs.kolb-bot.ai/platforms/ios), [Android](https://docs.kolb-bot.ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.kolb-bot.ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.kolb-bot.ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.kolb-bot.ai/gateway/discovery)
- [Bonjour/mDNS](https://docs.kolb-bot.ai/gateway/bonjour)
- [Gateway pairing](https://docs.kolb-bot.ai/gateway/pairing)
- [Remote gateway README](https://docs.kolb-bot.ai/gateway/remote-gateway-readme)
- [Control UI](https://docs.kolb-bot.ai/web/control-ui)
- [Dashboard](https://docs.kolb-bot.ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.kolb-bot.ai/gateway/health)
- [Gateway lock](https://docs.kolb-bot.ai/gateway/gateway-lock)
- [Background process](https://docs.kolb-bot.ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.kolb-bot.ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs.kolb-bot.ai/logging)

## Deep dives

- [Agent loop](https://docs.kolb-bot.ai/concepts/agent-loop)
- [Presence](https://docs.kolb-bot.ai/concepts/presence)
- [TypeBox schemas](https://docs.kolb-bot.ai/concepts/typebox)
- [RPC adapters](https://docs.kolb-bot.ai/reference/rpc)
- [Queue](https://docs.kolb-bot.ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.kolb-bot.ai/tools/skills-config)
- [Default AGENTS](https://docs.kolb-bot.ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.kolb-bot.ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.kolb-bot.ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.kolb-bot.ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.kolb-bot.ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.kolb-bot.ai/reference/templates/TOOLS)
- [Templates: USER](https://docs.kolb-bot.ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.kolb-bot.ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.kolb-bot.ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.kolb-bot.ai/platforms/mac/voicewake)
- [iOS node](https://docs.kolb-bot.ai/platforms/ios)
- [Android node](https://docs.kolb-bot.ai/platforms/android)
- [Windows (WSL2)](https://docs.kolb-bot.ai/platforms/windows)
- [Linux app](https://docs.kolb-bot.ai/platforms/linux)

## Email hooks (Gmail)

- [docs.kolb-bot.ai/gmail-pubsub](https://docs.kolb-bot.ai/automation/gmail-pubsub)

## Molty

KolbBot was built for **Molty**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [kolb-bot.ai](https://kolb-bot.ai)
