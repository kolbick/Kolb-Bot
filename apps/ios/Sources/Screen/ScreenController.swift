...
final class ScreenController {
    ...
    /// Callback invoked when an kolb-bot:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = KolbBotKitResources.bundle
...
/// Handles navigation policy to intercept kolb-bot:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept kolb-bot:// deep links.
        if url.scheme?.lowercased() == "kolb-bot" {
