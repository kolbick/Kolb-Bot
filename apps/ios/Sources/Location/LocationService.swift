...
final class LocationService: NSObject, CLLocationManagerDelegate {
    ...
    func ensureAuthorization(mode: KolbBotLocationMode) async -> CLAuthorizationStatus {
    ...
    func currentLocation(
        params: KolbBotLocationGetParams,
    ...
    private static func accuracyValue(_ accuracy: KolbBotLocationAccuracy) -> CLLocationAccuracy {
        switch accuracy {
        case .coarse:
