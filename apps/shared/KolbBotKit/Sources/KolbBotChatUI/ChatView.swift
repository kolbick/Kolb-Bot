...
@MainActor
public struct KolbBotChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: KolbBotChatViewModel
    ...
    public init(
        viewModel: KolbBotChatViewModel,
    ...
    private var visibleMessages: [KolbBotChatMessage] {
        let base: [KolbBotChatMessage]
    ...
    private func mergeToolResults(in messages: [KolbBotChatMessage]) -> [KolbBotChatMessage] {
    ...
    private func isToolResultMessage(_ message: KolbBotChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: KolbBotChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: KolbBotChatMessage) -> String {
