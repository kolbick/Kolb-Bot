...
public typealias KolbBotPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias KolbBotPlatformImage = UIImage
#endif

public struct KolbBotChatUsageCost: Codable, Hashable, Sendable {
...
public struct KolbBotChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: KolbBotChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(KolbBotChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct KolbBotChatMessageContent: Codable, Hashable, Sendable {
...
public struct KolbBotChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [KolbBotChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: KolbBotChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [KolbBotChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: KolbBotChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(KolbBotChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([KolbBotChatMessageContent].self, forKey: .content) {
...
public struct KolbBotChatHistoryPayload: Codable, Sendable {
...
public struct KolbBotSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct KolbBotSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [KolbBotSessionPreviewItem]
}

public struct KolbBotSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [KolbBotSessionPreviewEntry]

    public init(ts: Int, previews: [KolbBotSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct KolbBotChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct KolbBotChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct KolbBotAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct KolbBotChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct KolbBotGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct KolbBotPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: KolbBotPlatformImage?
...
public struct KolbBotChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
