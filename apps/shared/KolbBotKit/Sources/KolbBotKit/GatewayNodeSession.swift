...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.kolb-bot", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.kolb-bot", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: KolbBotProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
