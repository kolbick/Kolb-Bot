...
public enum KolbBotCanvasA2UICommand: String, Codable, Sendable {
...
public struct KolbBotCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct KolbBotCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
