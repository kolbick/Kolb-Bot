...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = KolbBotChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = KolbBotChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
