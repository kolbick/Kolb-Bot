...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = KolbBotConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = KolbBotConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = KolbBotConfigFile.loadDict()
            ...
            KolbBotConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/kolb-bot"
        state.remoteCliPath = ""
        return state
    }
}
