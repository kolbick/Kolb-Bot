...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.kolb-bot", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return KolbBotConfigFile.defaultWorkspaceURL() }
