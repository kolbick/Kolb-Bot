...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.kolb-bot", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("KolbBot/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__kolb-bot__/a2ui/").absoluteString + "?platform=macos"
    }
