...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.kolb-bot", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".kolb-bot/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.kolb-botCommand(
            subcommand: "gateway",
