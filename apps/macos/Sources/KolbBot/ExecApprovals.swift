...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.kolb-bot", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        KolbBotPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        KolbBotPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
