...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (KolbBot token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: KolbBotOAuthStore.AnthropicOAuthStatus = KolbBotOAuthStore
...
enum AnthropicOAuth {
    private static let logger = Logger(subsystem: "ai.kolb-bot", category: "anthropic-oauth")
...
enum KolbBotOAuthStore {
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "KolbBot OAuth token file not found"
            case .unreadableFile: "KolbBot OAuth token file not readable"
            case .invalidJSON: "KolbBot OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in KolbBot OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "KolbBot OAuth credentials found"
            }
        }
    }
    ...
    static func oauthDir() -> URL {
        ...
        let preferred = home.appendingPathComponent(".kolb-bot", isDirectory: true)
