...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .kolb-botSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? KolbBotPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? KolbBotPaths.stateDirURL.path
...
extension Notification.Name {
    static let kolb-botSelectSettingsTab = Notification.Name("kolb-botSelectSettingsTab")
}
