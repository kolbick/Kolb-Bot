...
final class PeekabooBridgeHostCoordinator {
    ...
    private let logger = Logger(subsystem: "ai.kolb-bot", category: "PeekabooBridge")
    ...
    private static var kolb-botSocketPath: String {
        ...
        let directory = base.appendingPathComponent("KolbBot", isDirectory: true)
    ...
    private func startIfNeeded() async {
        ...
        let services = KolbBotPeekabooBridgeServices()
...
@MainActor
private final class KolbBotPeekabooBridgeServices: PeekabooBridgeServiceProviding {
    ...
    init() {
        let logging = LoggingService(subsystem: "ai.kolb-bot.peekaboo")
