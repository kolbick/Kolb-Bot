...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/kolb-bot/kolb-bot") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/kolb-bot/kolb-bot")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://github.com/kolbick/Kolb-Bot")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "KolbBotBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "KolbBotBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "KolbBotGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "KolbBotGitCommit") as? String) ??
            "unknown"
    }
