...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.kolb-bot", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other KolbBot windows, but below the system’s pop-up menus.
