...
enum UIStrings {
    static let welcomeTitle = "Welcome to KolbBot"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "kolb-bot.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: KolbBotOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: KolbBotChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g kolb-bot@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: KolbBotChatViewModel(
