...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.kolb-bot", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.kolb-bot", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [KolbBotChatMessage] = messages.compactMap { item in
