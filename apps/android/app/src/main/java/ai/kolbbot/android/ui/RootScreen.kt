...
import ai.kolb-bot.android.CameraHudKind
  ...
  AndroidView(
    ...
    factory = {
      WebView(context).apply {
        ...
        if (isDebuggable) {
          Log.d("KolbBotWebView", "userAgent: ${settings.userAgentString}")
        }
        ...
        webViewClient =
          object : WebViewClient() {
            override fun onReceivedError(
              ...
              Log.e("KolbBotWebView", "onReceivedError: ${error.errorCode} ${error.description} ${request.url}")
            }
            ...
            override fun onPageFinished(view: WebView, url: String?) {
              if (isDebuggable) {
                Log.d("KolbBotWebView", "onPageFinished: $url")
              }
