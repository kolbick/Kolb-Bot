...
import ai.kolb-bot.android.LocationMode
import ai.kolb-bot.android.MainViewModel
import ai.kolb-bot.android.NodeForegroundService
import ai.kolb-bot.android.VoiceWakeMode
import ai.kolb-bot.android.WakeWords
  ...
  LazyColumn(
      ...
      AnimatedVisibility(visible = voiceWakeMode != VoiceWakeMode.Off) {
        Column(verticalArrangement = Arrangement.spacedBy(6.dp), modifier = Modifier.fillMaxWidth()) {
          ListItem(
            ...
            supportingContent = { Text("Listens only while KolbBot is open.") },
            trailingContent = {
              RadioButton(
    ...
    item {
      Column(verticalArrangement = Arrangement.spacedBy(6.dp), modifier = Modifier.fillMaxWidth()) {
        ...
        ListItem(
          ...
          supportingContent = { Text("Only while KolbBot is open.") },
          trailingContent = {
            RadioButton(
    ...
    item {
      ListItem(
        ...
        supportingContent = { Text("Keeps the screen awake while KolbBot is open.") },
