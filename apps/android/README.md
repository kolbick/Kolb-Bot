## KolbBot Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_kolb-bot-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm kolb-bot gateway --port 18789 --verbose
```
